...
public class SignosVitalesResponse {
    ...
    public SignosVitalesResponse(Float altura, Float peso, Float presionSistolica, Float presionDiatolica, Float glucosa, Float oxigenacion, Float imc, Float frecuencia_cardiaca, Float temperatura) {
